...
func getProviderConfFile() string {
	if config := os.Getenv("TEST_MULTIPASS_CONFIG"); config != "" {
		return config
	}

	return "../test/config/multipass/provider.json"
}
...
func getTestFile() string {
	...
	return "../test/config/multipass/config.json"
}
...
func getMachinesFile() string {
	...
	return "../../test/config/multipass/machines.json"
}
