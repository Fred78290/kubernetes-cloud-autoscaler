...
import (
	...
	nodemanagerv1alpha2 "github.com/Fred78290/kubernetes-cloud-autoscaler/pkg/apis/nodemanager/v1alpha2"
	versioned "github.com/Fred78290/kubernetes-cloud-autoscaler/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/Fred78290/kubernetes-cloud-autoscaler/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha2 "github.com/Fred78290/kubernetes-cloud-autoscaler/pkg/generated/listers/nodemanager/v1alpha2"
...
type ManagedNodeInformer interface {
	...
	Lister() v1alpha2.ManagedNodeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NodemanagerV1alpha2().ManagedNodes().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NodemanagerV1alpha2().ManagedNodes().Watch(context.TODO(), options)
			},
		},
		&nodemanagerv1alpha2.ManagedNode{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *managedNodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodemanagerv1alpha2.ManagedNode{}, f.defaultInformer)
}

func (f *managedNodeInformer) Lister() v1alpha2.ManagedNodeLister {
	return v1alpha2.NewManagedNodeLister(f.Informer().GetIndexer())
}
